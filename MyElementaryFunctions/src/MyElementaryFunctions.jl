...
my_Remez_minimax_approx, my_error_value_polynomial, my_error_value_polynomial_fma, my_refined_error_value_polynomial, my_refined_error_value_polynomial_fma, my_exp


include("my_base_operators.jl")
include("my_Remez_minimax_approx.jl")
include("my_polynomials.jl")
include("my_elementary_value.jl")
